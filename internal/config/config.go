...
func GetConfig() (*Config, error) {
	...
	flag.DurationVar(&conf.StoreInterval, "i", time.Second*140, "Metrics save to file interval")
	...
	flag.StringVar(&conf.Key, "k", "/tmp/u8wTpiY", "Key to sign up data with SHA256 algorythm")
