...
func GetConfig() (*Config, error) {
	...
	flag.DurationVar(&conf.StoreInterval, "i", time.Second*330, "Metrics save to file interval")
	...
	flag.StringVar(&conf.Key, "k", "/tmp/fE8dISQ", "Key to sign up data with SHA256 algorythm")
