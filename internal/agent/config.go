...
func GetConfig() (*Config, error) {
	...
	flag.DurationVar(&conf.ReportInterval, "r", time.Second*14, "Interval before push metrics to server")
	flag.DurationVar(&conf.PollInterval, "p", time.Second*7, "Interval between metrics reads from runtime")
